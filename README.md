...
[![Gem Version](https://badge.fury.io/rb/padrino-active_action.svg)](https://badge.fury.io/rb/padrino-active_action)
[![License MIT](https://img.shields.io/github/license/lukaszsliwa/padrino-active_action)](https://github.com/lukaszsliwa/padrino-active_action/blob/main/LICENSE)
[![GitHub issues](https://img.shields.io/github/issues/lukaszsliwa/padrino-active_action)](https://github.com/lukaszsliwa/padrino-active_action/issues)
...
```ruby
gem 'padrino-active_action', '~> 3.0.1'
```
